...
const VideoCompressor = () => (
  <ToolPage tool={tool}>
    ...
    <div className="rounded-lg border border-dashed border-border bg-card/50 p-8 text-center text-muted-foreground text-sm">Drop a video above to compress.</div>
  </ToolPage>
);
